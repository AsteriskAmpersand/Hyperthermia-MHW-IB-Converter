...
from imrl3.maptype import maptypeTranslation
from imrl3.shadertype import shaderTranslation as shadermapTranslation
...
if "__main__" in __name__:
    ...
    testPath = Path(r"E:\MHW\ChunkG0\Master_MtList.mrl3")
    m = MRL3()
